...
\begin{algorithm}[p]
    ...
    \For{每个$agent_i$}{
        ...
        }
        {
            ...
            使用$\mathbf{b'}$重新运行算法\ref{jichumoxing2tanxin2}，得到各个胜出者产生时对应的图序列（并非可图序列相关概念）$\mathbf{GS}=G_1,G_2,G_3...G_u$，每个$G_i$是算法\ref{jichumoxing2tanxin2}中的一个新的可行解$S'$对应的DAG\;
